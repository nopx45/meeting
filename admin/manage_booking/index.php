  ...
  <tr>
    <td align="center">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td align="center" bgcolor="#000000" height="30"><font color="#FFFFFF"><b>:: Manage Booking ::</b></font></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
...
$strSQL1 = "SELECT * FROM booking_tb";
$result1 = mysql_query($strSQL1);
$total1 = mysql_num_rows($result1); // หาจำนวน record

$strSQL2 = "SELECT * FROM booking_tb ORDER BY booking_date DESC LIMIT $start,$limit";
