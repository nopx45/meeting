...
<select name="booking_status">
      <option value="ACTIVE" <?php if($row['booking_status'] == "ACTIVE") echo "selected"; ?>>Approved</option>
      <option value="NOT_ACTIVE" <?php if($row['booking_status'] == "NOT_ACTIVE") echo "selected"; ?>>Not Approved</option>
</select>
    <font color="red">*</font></div></td>
  </tr>
