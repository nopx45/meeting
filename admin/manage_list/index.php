...
<form action="add_list_in.php" name="form1" method="post" onsubmit="return checkform(this);">
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="2">

  <tr>
    <td bgcolor="#000000" colspan="2" height="30" align="center"><font color="#FFFFFF"><b>:: Manage List ::</b></font></td>
  </tr>
...
<select name="list_type">
      ...
      <option value="อุปกรณ์ที่ใช้">EQUIPMENT</option>
      <option value="เตรียมอาหาร">FOOD</option>
</select>
  ...
  <tr>
    ...
    <td bgcolor="#F2F5F5"><div align="left"><input name="list_name" type="text" size="60" maxlength="200" /> <font color="red">*</font></div></td>
  </tr>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="2">
  ...
  <tr>
    <td bgcolor="#000000" colspan="3" height="30" align="center"><font color="#FFFFFF"><b>:: Equipment ::</b></font></td>
  </tr>

  <tr>
    <td bgcolor="#C1CBCB" width="84%"><div align="center">List Name</div></td>
    <td bgcolor="#C1CBCB" width="8%"><div align="center">Edit</div></td>
    <td bgcolor="#C1CBCB" width="8%"><div align="center">Delete</div></td>
  </tr>

<?php
$strSQL = "SELECT * FROM list_tb WHERE list_type = 'อุปกรณ์ที่ใช้' ORDER BY id";
...
?>
  ...
  <tr>
    <td bgcolor="#F2F5F5"><div align="left"><?php echo $row['list_name']; ?></div></td>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="2">
  ...
  <tr>
    <td bgcolor="#000000" colspan="3" height="30" align="center"><font color="#FFFFFF"><b>:: Food ::</b></font></td>
  </tr>
...
<?php
$strSQL = "SELECT * FROM list_tb WHERE list_type = 'เตรียมอาหาร' ORDER BY id";
$result = mysql_query($strSQL);
