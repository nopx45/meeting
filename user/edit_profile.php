...
<form action="edit_profile_in.php" name="form1" method="post" onsubmit="return checkform(this);">
<input type="hidden" name="id" value="<?php echo $row['id']; ?>">
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="2">

  <tr>
    <td bgcolor="#000000" colspan="2" height="30" align="center"><font color="#FFFFFF"><b>:: Edit Profiles ::</b></font></td>
  </tr>


  <tr>
    <td bgcolor="#C1CBCB"><div align="right">Username :&nbsp;</div></td>
    <td bgcolor="#F2F5F5"><div align="left"><font color="red"><?php echo $username; ?></font></div></td>
  </tr>

  <tr>
    <td bgcolor="#C1CBCB"><div align="right">Password :&nbsp;</div></td>
    <td bgcolor="#F2F5F5"><div align="left"><input name="password" type="password" value="<?php echo $row['password']; ?>" size="60" maxlength="50" /> <font color="red">*</font></div></td>
  </tr>
  <tr>
